...
public class GestorAtencion {
    ...
    /**
     * Muestra la bitácora de citas atendidas durante la sesión actual,
     * tanto en consola como en una ventana emergente. En la ventana se
     * distingue visualmente cada registro según su tiempo de espera:
     * 
